package com.example.openurl.niapsec
...
import com.example.openurl.niapsec.databinding.ActivityMainBinding
    ...
    if (provider != null) {
        ...
        services.forEach { service ->
            if (service.type == "Signature" || service.type == "MessageDigest") {
                android.util.Log.d("CertCheck", "Type: ${service.type}, Algorithm: ${service.algorithm}")
            }
        }
    } else {
        android.util.Log.d("CertCheck", "Conscrypt provider not found!")
    }
